...
export function StreetCard({ street }: StreetCardProps) {
  return (
    <article className="relative overflow-hidden rounded-md border border-herbal-brown/20 bg-white p-5 shadow-sm">
      <div
        aria-hidden="true"
      ...
      <h3 className="mt-3 text-lg font-extrabold leading-tight text-herbal-ink">
        {street.streetName}
      </h3>
      {street.description ? (
