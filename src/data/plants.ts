...
export const plants: Plant[] = [
  {
    ...
    description:
      "Jahe merupakan tanaman rimpang beraroma kuat yang sering dimanfaatkan dalam minuman hangat dan bumbu dapur.",
    usedParts: ["Rimpang"],
    traditionalUses: [
    ...
    locationStatus: "Lokasi tanaman tercatat di peta kampung.",
    source: "Berdasarkan pengetahuan umum tanaman TOGA.",
    validator: "Tim Farmasi KKN Kampung Herbal Berua.",
  ...
  },
  {
    ...
    description:
      "Serai memiliki batang beraroma lemon yang banyak digunakan dalam dapur rumah tangga.",
  ...
  },
  {
    ...
    description:
      "Temulawak merupakan tanaman rimpang yang sering dikaitkan dengan tradisi jamu Indonesia.",
    usedParts: ["Rimpang"],
    traditionalUses: [
      "Secara tradisional digunakan untuk membantu menjaga kebugaran.",
